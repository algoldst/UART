...
set_property PACKAGE_PIN V2 [get_ports {dataIn[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dataIn[8]}]
set_property PACKAGE_PIN T3 [get_ports {dataIn[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dataIn[9]}]
set_property PACKAGE_PIN T2 [get_ports {dataIn[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dataIn[10]}]
set_property PACKAGE_PIN R3 [get_ports {dataIn[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dataIn[11]}]
set_property PACKAGE_PIN W2 [get_ports {dataIn[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dataIn[12]}]
set_property PACKAGE_PIN U1 [get_ports {dataIn[13]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dataIn[13]}]
set_property PACKAGE_PIN T1 [get_ports {dataIn[14]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dataIn[14]}]
set_property PACKAGE_PIN R2 [get_ports {dataIn[15]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dataIn[15]}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports sendBtn]						
...
##Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {JAbsI}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JAbsI}]
##Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {JAsigI}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JAsigI}]
##Sch name = JA9
